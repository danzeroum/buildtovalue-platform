...
| **Cancelamento fecha esperas** | `POST /v1/instances/:id/cancel` → engine emite CloseUserTask/CancelTimer/CancelJob para TODAS as esperas; teste comprova: task some (`cancelled`), timer não dispara (varredura ignora), segundo cancel = 409. |
